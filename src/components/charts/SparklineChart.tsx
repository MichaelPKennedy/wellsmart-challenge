...
const MAX_DISPLAY_POINTS = 20; // Maximum points to display on sparkline
...
export function SparklineChart({
  ...
  const chartData = useMemo(() => {
    ...
    const consolidationFactor = Math.ceil(rawPoints.length / MAX_DISPLAY_POINTS);
